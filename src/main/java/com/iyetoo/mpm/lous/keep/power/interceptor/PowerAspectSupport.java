...
import com.iyetoo.mpm.lous.keep.power.support.*;
...
/**
 * This class define whole method call chain .Any {@link PowerInvokeCollector} define
 * responsible for collector data for subsquence {@link PowerHandler} call。
 * *
 ...
 * |              /|\                                  .               |
 * |               .                                   .               |
 * |                PowerHandlerRunContainer#hadlerError               |
 * |               .                                  \|/              |
 * |    +----------+----------+            +-----------+----------+    |
 ...
 * @author JacceYang
 *
 * @since 1.0.0 Initialized in 1:26 PM 2019/8/19
 **/
